# F4 Paused Execution Checklist

Last updated: 2026-09-12

Archived: 2026-09-14

Status: historical execution ledger paused after Batch 3R R5. References below
to an “active gate,” “next action,” or continuing R6.1 record the state before
the demo-first roadmap rebaseline. They do not authorize current work. The
implementation-depth audit is
[`2026-09-12-f4-implementation-depth-audit.md`](2026-09-12-f4-implementation-depth-audit.md),
and current execution has moved back to `docs/current-focus.md` for F7.
...
[`2026-08-24-f3-execution-checklist.md`](2026-08-24-f3-execution-checklist.md),
and its final executable evidence is in
[`2026-08-22-f3-exit-proof.md`](2026-08-22-f3-exit-proof.md).
...
- [x] The pre-implementation audit is recorded in
      [`2026-08-24-f4-authority-audit.md`](2026-08-24-f4-authority-audit.md).
...
[`Batch 1 Item 1 Source Reconciliation`](2026-08-24-f4-authority-audit.md#batch-1-item-1-source-reconciliation).
...
- [x] The ADR has one selected owner per authoritative concept, rejected
      ...
      boundary.
      Evidence:
      [F4 Batch 1 exit matrix](2026-08-24-f4-batch1-exit-matrix.md)
...
- [x] Prove deterministic seed reruns, migration deploy/status, readiness,
      ...
      [F4 Batch 2 exit proof](2026-08-26-f4-batch2-exit-proof.md).
...
- [x] Historical default-realm foundation: keep the then-current global User
      ...
      [F4 Batch 3 execution checklist](2026-08-26-f4-batch3-execution-checklist.md).
...
- [x] `R0_REBASELINE`: start a new evidence ledger from current source, rerun
      ...
      [F4 Batch 3R execution checklist](2026-09-01-f4-batch3r-execution-checklist.md).
...
- [x] `R2_DEFAULT_ACTOR_BACKFILL`: add realm-qualified Membership,
      ...
      [F4 Batch 3R execution checklist](2026-09-01-f4-batch3r-execution-checklist.md#r2_default_actor_backfill).
