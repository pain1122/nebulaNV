...
- [x] Add bounded retention for dependency, image, and safe secret/config scan reports.
- [x] Add non-interpolated sanitized Compose configurations and bounded failure logs.
