...
(function(n){"function"===typeof define&&define.amd?define(["jquery","datatables.net","datatables.net-buttons"],function(u){return n(u,window,document)}):"object"===typeof exports?module.exports=function(u,x,E,F){u||(u=window);x&&x.fn.dataTable||(x=require("datatables.net")(u,x).$);x.fn.dataTable.Buttons||require("datatables.net-buttons")(u,x);return n(x,u,u.document,E,F)}:n(jQuery,window,document)})(function(n,u,x,E,F,B){function I(a){for(var c="";0<=a;)c=String.fromCharCode(a%26+65)+c,a=Math.floor(a/
    ...
    (g=e.messageTop+f+f+g);e.messageBottom&&(g=g+f+f+e.messageBottom);b.customize&&(g=b.customize(g,b,c));b=n("<textarea readonly/>").val(g).appendTo(d);if(x.queryCommandSupported("copy")){d.appendTo(c.table().container());b[0].focus();b[0].select();try{var p=x.execCommand("copy");d.remove();if(p){c.buttons.info(c.i18n("buttons.copyTitle","کپی در کلیپ‌بورد"),c.i18n("buttons.copySuccess",{1:"یک سطر در کلیپ‌بورد کپی شد",_:"%d سطر در کلیپ‌بورد کپی شد"},a.rows),2E3);this.processing(!1);return}}catch(q){}}p=
    n("<span>"+c.i18n("buttons.copyKeys","برای کپی کردن داده‌های جدول، <i>Ctrl</i> یا <i>⌘</i> + <i>C</i> را فشار دهید<br>تا در کلیپ‌بورد سیستم شما ذخیره شود.<br><br>برای لغو، این پیام را کلیک کنید یا دکمه Escape را فشار دهید.")+"</span>").append(d);c.buttons.info(c.i18n("buttons.copyTitle","کپی در کلیپ‌بورد"),p,0);b[0].focus();b[0].select();var t=n(p).closest(".dt-button-info"),h=function(){t.off("click.buttons-copy");n(x).off(".buttons-copy");c.buttons.info(!1)};t.on("click.buttons-copy",h);n(x).on("keydown.buttons-copy",function(q){27===
