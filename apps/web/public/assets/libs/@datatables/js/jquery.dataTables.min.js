...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": فعال کردن برای مرتب‌سازی صعودی ستون",sSortDescending:": فعال کردن برای مرتب‌سازی نزولی ستون"},oPaginate:{sFirst:"اولین",sLast:"آخرین",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"داده‌ای در جدول موجود نیست",sInfo:"نمایش _START_ تا _END_ از _TOTAL_ ورودی",sInfoEmpty:"نمایش 0 تا 0 از 0 ورودی",sInfoFiltered:"(فیلتر شده از _MAX_ ورودی کل)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ ورودی",sLoadingRecords:"درحال پردازش...",sProcessing:"در حال پردازش...",sSearch:"جستجو:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"هیچ نتیجه‌ای یافت نشد"}
,oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};E(u.defaults);u.defaults.column={aDataSort:null,
