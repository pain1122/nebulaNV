...
export class ProductGrpcController {
  ...
  update(req: { id: string; data: any }) { return this.svc.update(req.id, req.data); }

  @GrpcMethod('ProductService', 'GetProduct')
  get(req: { id: string }) { return this.svc.get(req.id); }

  @GrpcMethod('ProductService', 'ListProducts')
  list(req: any) { return this.svc.list(req); }

  @GrpcMethod('ProductService', 'DeleteProduct')
  del(req: { id: string }) { return this.svc.softDelete(req.id); }

  @GrpcMethod('ProductService', 'RestoreProduct')
  restore(req: { id: string }) { return this.svc.restore(req.id); }

  @GrpcMethod('ProductService', 'HardDeleteProduct')
  hardDelete(req: { id: string }) { return this.svc.hardDelete(req.id); }

  @GrpcMethod('ProductService', 'ApplyDiscountBulk')
  applyDiscountBulk(req: any) { return this.svc.applyDiscountBulk(req); }
